...
static const R_CallMethodDef CallEntries[] = {
    ...
    {"C_parse_mzml", (DL_FUNC)&C_parse_mzml, 2},
    {"C_bin_to_json", (DL_FUNC)&C_bin_to_json, 2},
    {"C_parse_mzml_to_json", (DL_FUNC)&C_parse_mzml_to_json, 2},
    ...
    {"C_bin_to_eic", (DL_FUNC)&C_bin_to_eic, 6},
